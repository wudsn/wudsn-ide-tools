...
;	sta $d01a
	...
	stz	z00m+1			; DLIV bez ZOOMa czyli normal
...
set_col	regA	16
	mva	TDL1,X	DL5Ek0+1	; reszta wartosci
	mva	TDL5,X	DL5Sk1+1

	mva	tdl_dll0,x	dll5+2
	regA	8
	jmp	color
...
Koment4 equ *
 dta d' XL-Paint 2.6MaX '
 dta d' by Stanley/USG  '
 dta d' by TeBe/Madteam '
 dta d' date 11-08-2006 '
...
cp0	mva	kolor1	(POM1),Y
	...
	dex
CLSS2	ldy #38
cp1	mva	kolor2	(POM1),Y
	mva	kolor1	(POM2),Y
	:2 dey
	bpl cp1

	jsr AddPom	; po zakonczeniu jest juz regA 8
	dex
	bne CLSS1
...
LInp	lda $358	;czy = 16004 ?
	...
	regA	16
	mva	#Ekran10+8000+$1e00	PomADR1
	mva	#Ekran20+$1e00		PomADR2
	regA	8
...
;	mva	#Bufor1+$700	ZmL2+1
;	mva	#Bufor1+$701	ZmL3+1

;	mva	#Bufor2+$700	ZmL4+1
;	mva	#Bufor2+$701	ZmL5+1
...
ZmRight
	...
	mva	#Bufor1-$7F	ZmR2+1
	mva	#Bufor1-$80	ZmR3+1

	mva	#Bufor2-$7F	ZmR4+1
	mva	#Bufor2-$80	ZmR5+1
...
ZmR5	sta $ffff,y
	...
	regA	16
	mva	#Bufor1+39	PUTZ1+1
	mva	#Bufor2+39	PUTZ2+1
	regA	8
...
ZmDown
	...
	mva	#Bufor1-$80	ZmD2+1
	mva	#Bufor1-$A8	ZmD3+1

	mva	#Bufor2-$80	ZmD4+1
	mva	#Bufor2-$A8	ZmD5+1
...
ZmD5	sta $ffff,y
	...
	mva	#Bufor1+1880	PUTZ1+1
	mva	#Bufor2+1880	PUTZ2+1
...
copy	mva	Ekran10,x	Ek01,x		; w ten sposob mniej mruga
	mva	Ekran20,x	Ek02,x

	:2 dex
	bpl copy


;	move Ekran10 Ek01 $1e00-1
;	move Ekran20 Ek02 $1e00-1
...
copy	mva	Ek01,x	Ekran10,x
	mva	Ek02,x	Ekran20,x

	:2 dex
	bpl copy

;	move Ek01 Ekran10 $1e00-1
;	move Ek02 Ekran20 $1e00-1
...
copy	ldx	Ekran10,y
	mva	Ek01,y	Ekran10,y
	txa
	sta	Ek01,y

	ldx	Ekran20,y
	mva	Ek02,y	Ekran20,y
	txa
	sta	Ek02,y
...
T_I equ *
 ...
 Dta a($FFEA),l(NMIVEC)
 Dta a($FFEB),h(NMIVEC)
 Dta a($FFEC),l(RESETVEC)
 Dta a($FFED),h(RESETVEC)
 Dta a($FFEE),l(IRQVEC)
 Dta a($FFEF),h(IRQVEC)
