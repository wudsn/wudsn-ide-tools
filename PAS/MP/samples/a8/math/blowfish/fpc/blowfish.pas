...
begin
{
      write(hexStr( block[0] and $ff ,2));
      write(hexStr( (block[0] shr 8) and $ff ,2  ));
      write(hexStr( (block[0] shr 16) and $ff,2  ));
      write(hexStr( (block[0] shr 24) and $ff,2  ));

      write(hexStr( block[1] and $ff,2 ));
      write(hexStr( (block[1] shr 8) and $ff,2   ));
      write(hexStr( (block[1] shr 16) and $ff ,2 ));
      write(hexStr( (block[1] shr 24) and $ff ,2 ));
      }
