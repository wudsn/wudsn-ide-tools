...
type Procedure_Type = procedure(In1, In2, In3 : integer; var Result    : integer);
...
var Number1, Number2, Number3 : integer;
   ...
   procedure Add(In1, In2, In3 : integer; var Result    : integer); StdCall;
   begin
      Result := In1 + In2 + In3;
      Writeln('The sum of the numbers is     ',Result:6);
   end;

   procedure Mult(In1, In2, In3 : integer; var Result    : integer); StdCall;
   begin
      Result := In1 * In2 * In3;
      Writeln('The product of the numbers is ',Result:6);
   end;

   procedure Average(In1, In2, In3 : integer; var Result    : integer); StdCall;
   begin
